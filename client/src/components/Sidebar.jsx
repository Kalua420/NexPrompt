...
import { LayoutDashboard, Zap, Circle, CreditCard, Settings, Sparkles, Crown } from 'lucide-react';
...
export default function Sidebar() {
  ...
  const { plan, isPremium, tier } = useTier();
    ...
    <AnimatePresence>
      {sidebarOpen && (
        <motion.aside
          ...
          className="fixed left-0 top-0 h-screen w-64 bg-black/40 backdrop-blur-xl border-r border-border z-40 p-5 flex flex-col gap-1"
        >
